defmodule PdfGeneratorTest do
  ...
  test_with_server "basic PDF generation from url" do
    route "/pdf", FakeServer.HTTP.Response.ok("<html><body><h1>Hi</h1><p>Yikes!</p></body></html>",
        %{"content-type" => "text/html"})
    
    {:ok, temp_filename } = PdfGenerator.generate "http://#{FakeServer.address}/pdf"
